...
const ColorModal = ({ visible, onClose, onSelect, defaultColor = '#7FB3FF' }: ColorModalProps) => {
    ...
    <Modal visible={visible} transparent animationType="fade">
      <View className="flex-1 justify-center items-center bg-black/40 px-6">
        <View className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl max-h-[80%]">
          ...
          {/* ✅ Wrap in a View to apply styling */}
          ...
          <Pressable
            onPress={handleDone}
            className="mt-16 bg-black rounded-full py-3"
          >
            <Text className="text-white text-center font-semibold">Done</Text>
          </Pressable>
        </View>
